...
function App() {
  ...
  const [activeTab, setActiveTab] = useState<'wallets' | 'performance'>('wallets')
      ...
      <div className="max-w-[95%] mx-auto space-y-8">
        ...
        <div className="flex space-x-4 border-b border-slate-800 pb-2">
          <button
            ...
            className={`px-4 py-2 font-semibold text-lg transition-all rounded-lg cursor-pointer ${
              activeTab === 'wallets'
