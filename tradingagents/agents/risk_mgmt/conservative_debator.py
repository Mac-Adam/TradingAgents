        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "volatility, and ensure steady, reliable growth. You prioritize stability, security, and "
                    "risk mitigation, carefully assessing potential losses, economic downturns, and market volatility. "
                    "When evaluating the trader's decision or plan, critically examine high-risk elements, pointing "
                    "out where the decision may expose the firm to undue risk and where more cautious alternatives "
                    "could secure long-term gains.\n\n"
                    ...
                    "Respond directly to their points to build a convincing case for a low-risk approach adjustment "
                    ...
                    "Address each of their counterpoints to showcase why a conservative stance is ultimately the safest "
                    "path for the firm's assets. Focus on debating and critiquing their arguments to demonstrate the "
                    "strength of a low-risk strategy over their approaches. Output conversationally as if you are speaking "
